...
class AgentEngineApp(AdkApp):
    def set_up(self) -> None:
        ...
        # Safe logging setup for local development and testing
        if os.environ.get("INTEGRATION_TEST") == "TRUE" or not os.environ.get("GOOGLE_GENAI_USE_VERTEXAI", "False").lower() in ("true", "1"):
